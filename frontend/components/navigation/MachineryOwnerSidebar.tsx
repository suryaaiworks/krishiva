...
import { 
  ...
  Tractor, CalendarDays, DollarSign, Star, BarChart3,
...
const OWNER_NAV_ITEMS = [
  ...
  { href: "/machinery-owner/machines", label: "My Machines", icon: Tractor },
  { href: "/machinery-owner/bookings", label: "Booking Requests", icon: CalendarDays },
  { href: "/machinery-owner/earnings", label: "Earnings", icon: DollarSign },
  { href: "/machinery-owner/reviews", label: "Reviews & Ratings", icon: Star },
  { href: "/machinery-owner/analytics", label: "Analytics", icon: BarChart3 },
  { href: "/machinery-owner/notifications", label: "Notifications", icon: Bell },
  { href: "/machinery-owner/profile", label: "Profile", icon: User },
  { href: "/machinery-owner/settings", label: "Settings", icon: Settings },
];

export function MachineryOwnerSidebar() {
  ...
  React.useEffect(() => {
    setMounted(true);
    const saved = localStorage.getItem("machinery_owner_sidebar_collapsed");
    if (saved !== null) {
  ...
  const handleToggleCollapse = () => {
    ...
    localStorage.setItem("machinery_owner_sidebar_collapsed", String(nextState));
  };
        ...
        {OWNER_NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              {isActive && (
                <motion.div
                  layoutId="machinery-owner-sidebar-active"
