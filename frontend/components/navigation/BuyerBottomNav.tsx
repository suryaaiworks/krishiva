...
import { LayoutDashboard, FileText, Search, MessageSquare, User } from "lucide-react";
...
export function BuyerBottomNav() {
  ...
  const mobileItems = [
    ...
    { href: "/buyer/requests", label: "Buy Requests", icon: FileText },
    { href: "/buyer/search", label: "Search", icon: Search },
    { href: "/buyer/negotiation", label: "Negotiate", icon: MessageSquare },
        ...
        {mobileItems.map((item) => {
          ...
          return (
            ...
            >
              {isActive && (
                <motion.div
                  layoutId="buyer-bottom-nav-active"
