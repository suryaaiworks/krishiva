...
import { Settings, ShieldCheck, Bell, Palette, Lock } from "lucide-react";
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3.5 text-xs text-muted-foreground">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-foreground">SMS Booking Alerts</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="font-bold text-foreground">WhatsApp Direct Messaging</span>
                  <input type="checkbox" defaultChecked className="h-4 w-8 rounded-full appearance-none bg-muted checked:bg-primary transition-all cursor-pointer relative after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:h-3 after:w-3 after:rounded-full after:bg-card after:transition-all checked:after:translate-x-3.5" />
                </div>
                <div className="flex items-center justify-between">
                  <span className="font-bold text-foreground">Weekly Revenue Summary E-Mails</span>
                  <input type="checkbox" className="h-4 w-8 rounded-full appearance-none bg-muted checked:bg-primary transition-all cursor-pointer relative after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:h-3 after:w-3 after:rounded-full after:bg-card after:transition-all checked:after:translate-x-3.5" />
                </div>
              </div>
            </div>
