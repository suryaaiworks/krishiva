...
import { User, Phone, MapPin, ShieldCheck, Mail, Building } from "lucide-react";
          ...
          <Card className="lg:col-span-2 p-6 space-y-5 text-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4.5">
              ...
              <div className="space-y-1">
                ...
                <span className="font-bold text-foreground block text-sm">rajesh.kumar@agripartner.co.in</span>
              </div>
              <div className="space-y-1">
