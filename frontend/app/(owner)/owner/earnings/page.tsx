...
import { 
  ...
  ArrowDownLeft, Sparkles, Download, CheckCircle 
} from "lucide-react";
import { motion } from "framer-motion";

export default function EarningsPage() {
  const transactions = [
    { id: "TXN10293", date: "Oct 04, 2026", farmer: "Ramesh Patel", type: "Bank Transfer", amount: "₹9,600", status: "Settled" },
    { id: "TXN10292", date: "Oct 02, 2026", farmer: "Suresh Deshmukh", type: "UPI Payment", amount: "₹5,600", status: "Settled" },
    { id: "TXN10291", date: "Sep 28, 2026", farmer: "Amit Shinde", type: "Bank Transfer", amount: "₹1,500", status: "Settled" },
    { id: "TXN10290", date: "Sep 22, 2026", farmer: "Vikram Pawar", type: "UPI Payment", amount: "₹16,000", status: "Settled" },
    { id: "TXN10289", date: "Sep 15, 2026", farmer: "Karan Johar", type: "UPI Payment", amount: "₹3,000", status: "Refunded" },
  ];
                ...
                {transactions.map((txn) => (
                  <tr key={txn.id} className="hover:bg-muted/5 transition-colors">
                    ...
                    <td className="py-3 px-2 text-right">
                      <Badge 
                        variant={txn.status === "Settled" ? "success" : "outline"} 
                        className={`text-[8px] font-bold px-1.5 py-0 ${txn.status === "Refunded" ? "text-rose-500 bg-rose-500/5 border-rose-500/20" : ""}`}
                      >
                        {txn.status}
                      </Badge>
                    </td>
