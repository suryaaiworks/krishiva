...
import { Bell, ShoppingCart, DollarSign, MessageSquare, AlertCircle } from "lucide-react";

export default function BuyerNotificationsPage() {
  const [filter, setFilter] = React.useState<"all" | "sourcing" | "payment" | "system">("all");

  const notifications = [
    { id: 1, type: "sourcing", title: "Counter Offer Received", desc: "Ramesh Patel counter-offered ₹3,300/Ton for 15 Tons of Sugarcane.", time: "12 minutes ago", icon: MessageSquare, color: "text-primary bg-primary/10" },
    { id: 2, type: "payment", title: "Procurement Payment Disbursed", desc: "₹49,500 has been transferred successfully to Ramesh Patel's bank account for Order ORD90210.", time: "3 hours ago", icon: DollarSign, color: "text-emerald-600 bg-emerald-500/10" },
    { id: 3, type: "sourcing", title: "Direct Crop Match Found", desc: "New direct match found: Amit Shinde posted 4 Tons of Organic Bananas.", time: "Yesterday", icon: ShoppingCart, color: "text-primary bg-primary/10" },
