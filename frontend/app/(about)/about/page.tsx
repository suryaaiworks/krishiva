      ...
      <div className="space-y-8 animate-fade-in max-w-4xl mx-auto pb-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-1">
            <h1 className="font-heading text-2xl font-extrabold tracking-tight text-foreground flex items-center gap-2">
              About Krishiva <Sprout className="h-5 w-5 text-primary animate-pulse" />
            </h1>
            <p className="text-xs text-muted-foreground">
              Learn about our vision, tech stack, and commitment to rural agricultural empowerment.
            </p>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-[24px] border border-emerald-500/10 bg-gradient-to-r from-amber-500/5 via-emerald-600/5 to-transparent p-8 text-center space-y-4">
          ...
          <div className="space-y-2 max-w-xl mx-auto">
            <h2 className="text-2xl font-extrabold text-foreground">Empowering Farmers with AI</h2>
            <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
              Krishiva is a world-class, AI-first agricultural operating system designed to elevate smallholder and marginal farmers. By combining satellite telemetry, foliage diagnostics, B2B price comparisons, and voice-assisted translations, we minimize harvest losses and bypass crop brokerage barriers.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card title="" animate={false} className="p-6 space-y-4 bg-card border border-border/80 shadow-sm">
            <div className="flex items-center gap-2 pb-2 border-b border-border/50">
              ...
              <h4 className="font-bold text-xs text-foreground uppercase tracking-wider">Technical Architecture</h4>
            </div>
            ...
            <div className="space-y-3.5 text-xs text-muted-foreground leading-normal">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-foreground block">Frontend Stack</strong>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-foreground block">Backend APIs</strong>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-foreground block">AI & Agent Orchestrator</strong>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-foreground block">Database & Storage</strong>
          ...
          <Card title="" animate={false} className="p-6 space-y-4 bg-card border border-border/80 shadow-sm">
            <div className="flex items-center gap-2 pb-2 border-b border-border/50">
              ...
              <h4 className="font-bold text-xs text-foreground uppercase tracking-wider">Design & Product Principles</h4>
            </div>
            ...
            <div className="space-y-3.5 text-xs text-muted-foreground leading-normal">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-foreground block">Accessibility First</strong>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-foreground block">Data Integrity & Privacy</strong>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-foreground block">Open Collaboration</strong>
