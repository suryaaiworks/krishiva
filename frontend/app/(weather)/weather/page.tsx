...
const sevenDayForecast = [
  { 
    ...
    type: "sun", 
    advice: "Delay weeding operations. Soil temperature is high, meaning water evaporation is active. Focus on drip checks."
  },
  { 
    day: "Sunday", 
    temp: "23°C - 28°C", 
    ...
    type: "rain", 
    advice: "Skip irrigation entirely. Rain levels will exceed 22mm, leading to saturated clay soils. Clean drainage canals to avoid root drowning."
  },
  { 
    day: "Monday", 
    temp: "22°C - 27°C", 
    ...
    type: "rain", 
    advice: "Do not apply chemical sprays. Wet leaves will wash away fungicides. Siphon surface water from depressed field areas."
  },
  { 
    day: "Tuesday", 
    temp: "24°C - 29°C", 
    ...
    type: "cloud", 
    advice: "Ideal window for applying bio-fertilizers. Humid soils are highly receptive to nitrogen-fixing organic inputs."
  },
  { 
    day: "Wednesday", 
    temp: "25°C - 31°C", 
    ...
    type: "sun", 
    advice: "Excellent day for pesticide spraying. Low wind speed (8 km/h) minimizes chemical drift. Spray early morning."
  },
  { 
    day: "Thursday", 
    temp: "26°C - 32°C", 
    ...
    condition: "Clear Sky",
    type: "sun", 
    advice: "Start of Dry Spell. Increase evening drip cycles by 15% to maintain root moisture levels in Sugarcane rows."
  },
  { 
    day: "Friday", 
    temp: "25°C - 33°C", 
    ...
    condition: "Hot & Sunny",
    type: "sun", 
    advice: "Apply mulching to sugarcane rows. High UV index (9) will dry soil surfaces quickly. Soil cover preserves moisture."
  }
];
    ...
    <MainLayout>
      <div className="space-y-8 pb-16 animate-fade-in">
        ...
        <SectionHeader 
          ...
          description="Google Weather combined with AI agricultural insights to guide daily farming decisions."
          className="mb-0"
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <Card title="" animate={false} className="lg:col-span-2 p-6 flex flex-col justify-between relative overflow-hidden bg-gradient-to-tr from-primary/10 via-card to-accent/5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6 pt-5 border-t border-border/40 text-xs">
              <div className="space-y-1">
          ...
          <Card title="" animate={false} className="p-6 space-y-4">
            ...
            <div className="space-y-2 text-xs pt-1">
              ...
              <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                <li>Deploy mulching cover using Sugarcane foliage residues.</li>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div className="p-4 rounded-btn border border-border bg-card flex flex-col justify-between text-xs space-y-2 h-36">
              <div className="space-y-1">
                ...
                <p className="font-bold text-foreground leading-normal">
                  Sugarcane transpiration is modeled at 4.2mm/day.
                </p>
              </div>
